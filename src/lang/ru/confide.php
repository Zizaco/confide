...
return array(
    ...
    'alerts' => array(
        'account_created' => 'Ваш аккаунт успешно зарегистрирован.',
        'instructions_sent' => 'Проверьте ваш почтовый ящик и следуйте дальнейшим инструкциям, чтобы подтвердить свой адрес электронной почты.',
